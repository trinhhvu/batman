"""
back/tracker.py — Backend Logic for Dailymotion TRACK App
==========================================================
Handles: OAuth2, yt-dlp video scanning/downloading, config, history.
"""
...
HISTORY_PATH = os.path.join(TRACK_ROOT, "history.json")
...
class DailymotionTracker:
    ...
    def _init_download_path(self):
        ...
        if not os.path.isabs(folder):
            folder = os.path.join(TRACK_ROOT, folder)
